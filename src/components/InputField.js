      ...
      <div className="relative flex items-center justify-center">
        ...
        {showHide && (
          <div className="absolute right-0 mt-2 mr-3 cursor-pointer" onClick={toggleShowPassword}>
            {showPassword ? (
              <img
                src="https://tuk-cdn.s3.amazonaws.com/can-uploader/sign_in_2-svg6.svg" // Eye icon for hidden password
                alt="Hide"
              />
            ) : (
              <img
                src="https://tuk-cdn.s3.amazonaws.com/can-uploader/sign_in_2-svg5.svg" // Eye icon for visible password
                alt="Show"
              />
            )}
          </div>
